...
namespace AbstractClassVsInterface {
    ...
    // abstract class declaration // uncomplete class
    class AbstractClass 
    {
    public:
    ...
    // abstract class inheriting from an interface  // partial implementation of the interface(s)
    ...
    // concrete class inheriting directly from an interface 
    class ThirdConcreteClass : public Interface
    {
    public:
        ThirdConcreteClass(){}
    ...
    {
        // ConcreteClass* impl = new ConcreteClass();
       // ThirdConcreteClass* impl = new ThirdConcreteClass();
        AnotherConcreteClass* impl = new AnotherConcreteClass();
        return impl;
    }

    // lose coupling // interface // less problems
    // strong coupling // no flexibility
    ...
    static void test_client_of_interface()
    {
        ...
        static_cast<AnotherConcreteClass*> (ip)->my_method();  // Noooooooooooooooooooo
