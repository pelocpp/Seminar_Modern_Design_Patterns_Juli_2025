...
public:
    ...
    std::string request() const override {
        ...
        std::string toReverse{ m_adaptee->specificRequest() }; // toReverse: incompatible

        std::reverse(                  // example: convert to understandable format
            toReverse.begin(),
            toReverse.end()
        );
...
static void test_conceptual_example_01() {
    ...
    // Initialization: ===> Decision: What adapter do I need ???
